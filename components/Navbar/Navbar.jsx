...
const Navbar = ({loading}) => {
  ...
  return (
    <div
      style={{ zIndex: 1200 }}
      id="main-navbar"
      className="h-[60px] w-full flex items-center  justify-center fixed top-0 left-0 right-0 bg-white  transition-all duration-400 border-b-[1px] border-[#dbdbdb]  "
    >
      <div className="flex items-center justify-between  w-full px-5 md:max-w-[975px]">
        {/*Instagram Text SVG */}
        <div className="flex items-center justify-start lg:w-[333px] gap-x-2 flex-1">
          <svg
        ...
        {/*Search Bar*/}
        <div className=" items-center justify-end hidden w-[268px] md:flex h-9 bg-[#efefef] rounded-md relative flex-input">
          <input
            type="search"
            name=""
            id="searchBar"
            placeholder="Ara"
            className="flex  items-center justify-center lg:w-[236px] h-[30px] placeholder:opacity-0 focus:placeholder:opacity-100 focus:px-0 py-[3px] px-4 bg-[#efefef] outline-none"
          />
          <label
            htmlFor="searchBar"
        ...
        {/*Icons */}
        <div className="flex items-center justify-end lg:w-[333px] flex-1">
          
          <div className="h-6 w-6 ml-[22px]">
            <svg
          ...
          <div className="h-6 w-6 ml-[22px]">
            <img
              className="bg-fixed bg-center rounded-full  "
              src="https://picsum.photos/id/237/24/24"
              alt=""
            />
